...
import { Supplier, SupplierTransaction, SupplierRating, SupplierContract, SupplierContractPayment } from "@db/types";
...
export default function SupplierShow({ params }: { params: { id: string } }) {
  const go = useGo();
